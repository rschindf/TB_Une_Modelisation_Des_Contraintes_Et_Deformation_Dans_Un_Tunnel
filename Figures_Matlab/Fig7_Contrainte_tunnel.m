...
if i == 6, ylabel(c,'2e contrainte invariante, T_{II} / (2\eta_BD_B) [ ]'), end
...
saveas(z,fullfile('C:\Users\schin\OneDrive\Documents\Travail de Bachelor\Figure','Fig7_Contrainte_tunnel.tif'));
