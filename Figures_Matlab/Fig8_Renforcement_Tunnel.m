...
if i == 1, ylabel('Hauteur [ ]'), end, xlabel('Largeur [ ]')
fontsize(20,"points"), axis equal tight, axis([-Lx/2,Lx/2,-Ly/2,Ly/2])

end

saveas(z,fullfile('C:\Users\schin\OneDrive\Documents\Travail de Bachelor\Figure','Fig8_Renforcement_tunnel.tif'));
